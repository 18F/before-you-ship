...
1. Submit a request for a Privacy Threshold Analysis (PTA).
    1. Download the "Privacy Threshold Analysis (PTA) Template" from [this page](https://insite.gsa.gov/portal/content/627238).
    1. Send to [gsa.privacyact@gsa.gov](mailto:gsa.privacyact@gsa.gov).
