...
Work with your Authorization Concierge to categorize your system's impact levels, using the [ATO Levels](levels/) guide. GSA provides a "lightweight" ATO process designed for pilot systems running on GSA authorized infrastructure, for which fewer controls are in scope.
...
Work together with your Authorization Concierge on this step. The documentation generated by similar TTS projects can be helpful at this stage. Consult the checklist for examples. SSP templates are available for both GSA LATOs and FedRAMP ATOs.
